    ...
    <footer className="border-t border-dark-800 py-8 px-4">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-dark-400">&copy; 2026 ATS CV Generator</span>
        </div>
        <p className="text-xs text-dark-500">Your data is never stored or shared. Privacy first.</p>
      </div>
    </footer>
  );
}
